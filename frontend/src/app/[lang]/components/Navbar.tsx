...
export default function Navbar({
  ...
  return (
    <div className="p-4 dark:bg-black dark:text-gray-100">
      <div className="container flex justify-between h-16 mx-auto px-0 sm:px-6 border-b border-gray-100">
        {/* <Logo src={logoUrl}>
        ...
        <form
          action="https://www.beangenius.com/blog/"
          method="get"
          className="my-auto flex-end justify-end"
        >
